    ...
    table = $('.ajax-data-table').DataTable({
        ...
        },
        {
            "render": function (data, type, row, meta) {
                ...
                html += `<a href="/admin/CustomerForSale/Upsert?id=` + data + `"  class="btn text-white btn-warning"><i class="fa fa-edit "></i></a></div>`;
...
function DeleteItem(id) {
    Swal.fire({
        ...
        if (result.value) {
            $.ajax({
                type: "POST",
                url: '/admin/CustomerForSale/DisableEstate?Id=' + id,
...
function RestoreItem(id) {
    Swal.fire({
        ...
        if (result.value) {
            $.ajax({
                type: "POST",
                url: '/admin/CustomerForSale/ActiveEstate?Id=' + id,
                beforeSend: function () { $("button").prop("disabled", true); },
                complete: function () { $("button").prop("disabled", false); },
                success: function (data) {
