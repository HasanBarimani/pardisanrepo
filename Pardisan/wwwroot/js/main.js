$(document).ready(function () {
    ...
    //    quantity-selector--------------------
    jQuery('<div class="quantity-nav"><div class="quantity-button quantity-up plusQuantity">+</div><div class="quantity-button quantity-down minusQuantity">-</div></div>').insertAfter('.quantity input');
